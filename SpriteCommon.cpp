...
void SpriteCommon::Initialize(ID3D12Device* device, ID3D12GraphicsCommandList* cmdList, int window_width, int window_height)
{
	...
	// 並行投影の射影行列生成
	this->matProjection = XMMatrixOrthographicOffCenterLH(
...
{
	this->cmdList->SetGraphicsRootDescriptorTable(rootParameterIndex,
		CD3DX12_GPU_DESCRIPTOR_HANDLE(
			this->descHeap->GetGPUDescriptorHandleForHeapStart(),
			texNumber,
